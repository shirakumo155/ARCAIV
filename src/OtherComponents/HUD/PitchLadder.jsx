...
export function PitchLadder(props){
    ...
    const canvasYmin = props.PitchLadderHeight/2
    ...
    return(   
        ...
        ticks.map((el, i)=>{
            ...
            <text textAnchor="middle" fill="white" transform={"translate(" + (imgWidth*1.15) + ", 8)"} font-size="0.8em">{el.text}</text>
            <image
